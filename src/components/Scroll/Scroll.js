...
const styles = require('./scss/Scroll.scss');
/**
 * <Scroll
...
export default class Scroll extends Component {
  ...
  __HandlerRefresh() {
    ...
    const __differenceValue = body.scrollHeight - GoComRefresh.scrollHeight;
  ...
  render() {
    const { LoadType, RefreshComplete, NextDataComplete } = this.props;
    return (
      <div ref="GoComRefresh" className={styles.scrollCss} style={this.__GetStyle()}
