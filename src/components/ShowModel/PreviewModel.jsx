...
import { Utility, Refresh, ZdCarouselContent } from 'components';
const styles = require('./scss/PreviewModel.scss');
/**
 * 预览
 *  <PreviewModel />
 *
 */
export default class PreviewModel extends Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <div className={styles.previewModelCss} ref="goComPreviewModel" >
        ...
        <div className={styles.content} onClick={() => Utility.$previewModelHide()}>
          ...
          <div className={styles.pMode}>
            <Refresh RefreshComplete NextDataComplete onSlideLeft={this.__HandlerSlide.bind(this, true)}
              onSlideRight={this.__HandlerSlide.bind(this, false)}>
              <ZdCarouselContent ref="divCarousel" IsShowNumber PageIndex={cIndex || Index || 0} onNextPage={(index) => {
